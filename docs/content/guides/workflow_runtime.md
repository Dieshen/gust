...
- [Language Reference](../reference/) — complete syntax, types, and
  semantics
...
- [`gust-mcp/src/lib.rs`](https://github.com/Dieshen/gust/blob/master/gust-mcp/src/lib.rs) — source of truth for
  `gust_parse` JSON field names and the `serialize_program` function
- [`gust-stdlib/engine_failure.gu`](https://github.com/Dieshen/gust/blob/master/gust-stdlib/engine_failure.gu) —
